	...
	<body>
		...
		<div id="main">
			...
			<section id="content">
				...
				<div class="container">
					<?php
					$query = mysqli_query($koneksi, "SELECT * FROM user WHERE user_id='" . $_SESSION['user_id'] . "'");
						...
						<div class="col s12 m12 l6">
							...
							<div class="table table-responsive">
								...
								<div class="text-right">
									...
									<a href="edit-user.php" class="btn btn-sm btn-primary">Ubah Profile <i class="fa fa-arrow-circle-right"></i></a>
