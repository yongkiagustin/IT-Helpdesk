...
if (empty($_SESSION['username'])) {
    ...
    $masterQuery = "SELECT * FROM tiket JOIN user ON (tiket.user_id = user.user_id) WHERE user.departement_id = " . $_SESSION['departement_id'] . " ";
    $masterDataQuery = "SELECT fullname as name, problem, status FROM tiket JOIN user ON (tiket.user_id = user.user_id) WHERE user.departement_id = " . $_SESSION['departement_id'] . " ";
?>
    <!DOCTYPE html>
    <html lang="en">
        ...
        <div id="main">
            ...
            <section id="content">
                ...
                <div class="container">
                    ...
                    <div id="card-stats">
                        <div class="row">
                            <?php $tampil = mysqli_query($koneksi, $masterQuery . "AND status='open'");
                                ...
                                <div class="card">
                                    <div class="card-content  green white-text">
                                        ...
                                        <p class="card-stats-compare">
                                            <!-- <i class="mdi-hardware-keyboard-arrow-up"></i> --> <span class="green-text text-lighten-5">Belum Ditangani</span>
                                        </p>
                                    </div>
                            ...
                            <?php $tampil1 = mysqli_query($koneksi, $masterQuery . "AND status='close'");
                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content purple white-text">
                                        ...
                                        <p class="card-stats-compare">
                                            <!-- <i class="mdi-hardware-keyboard-arrow-up"></i> --> <span class="purple-text text-lighten-5">Sudah Ditangani</span>
                                        </p>
                                    </div>
                            ...
                            <?php $tampil2 = mysqli_query($koneksi, $masterQuery);
                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content blue-grey white-text">
                                        ...
                                        <p class="card-stats-compare">
                                            <!-- <i class="mdi-hardware-keyboard-arrow-up"></i> --> <span class="blue-grey-text text-lighten-5">Total Helpdesk Masuk</span>
                                        </p>
                                    </div>
                            ...
                            <?php $tampil3 = mysqli_query($koneksi, $masterQuery . "AND status = 'Cancel'");
                            ...
                            <div class="col s12 m6 l3">
                                <div class="card">
                                    <div class="card-content deep-purple white-text">
                                        ...
                                        <p class="card-stats-compare">
                                            <!-- <i class="mdi-hardware-keyboard-arrow-down"></i> 3% --><span class="deep-purple-text text-lighten-5">Total Helpdesk Cancel</span>
                                        </p>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col s12 m12 l6">
                                <ul id="projects-collection" class="collection">
                                    ...
                                    <?php
                                    $tanggal = date("Y/m/d");
                                    $query = $masterDataQuery . "AND status='open' limit 7";
                                    ...
                                    while ($data = mysqli_fetch_array($tampil)) {
                                        ...
                                        <li class="collection-item">
                                            <div class="row">
                                                <div class="col s9">
                                                    <p class="collections-title"><?php echo $no; ?>. <?php echo $data['name']; ?></p>
                            ...
                            <div class="col s12 m12 l6">
                                <ul id="issues-collection" class="collection">
                                    ...
                                    <?php
                                    $tanggal = date("Y/m/d");
                                    $query1 = $masterDataQuery . "AND status='close' limit 7";
