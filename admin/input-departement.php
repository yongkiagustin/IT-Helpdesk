      ...
      <section id="content">
        ...
        <div class="container">
          ...
          if (isset($_POST['input'])) {
            ...
            $update = mysqli_query($koneksi, "INSERT INTO departement (name) VALUES('$name')") or die(mysqli_error());
            if ($update) {
              echo '<script>sweetAlert({
	                                                   title: "Berhasil!", 
                                                        text: "Departemen Berhasil di simpan!", 
                                                        type: "success"
                                                        },function(){
              ...
              echo '<script>sweetAlert({
	                                                   title: "Gagal!", 
                                                        text: "Departemen Gagal di simpan, silahakan coba lagi!", 
                                                        type: "error"
                                                        });</script>';
            }
          }
          ...
          <div class="col s8 m8 l6">
            <div class="card-panel">
              <h4 class="header2">Input Departemen</h4>
              <div class="row">
