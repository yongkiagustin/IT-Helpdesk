<aside id="left-sidebar-nav">
    <ul id="slide-out" class="side-nav fixed leftside-navigation">
        ...
        <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
                <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-file-folder"></i> Master </a>
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="departement.php">Data Departement</a>
                            </li>
                            <li><a href="asset.php">Data Asset</a>
                            </li>
                        </ul>
                    </div>
                </li>
