    ...
    <div id="main">
      ...
      <section id="content">
        ...
        <div class="container">
          <?php
          $kd = $_GET['id'];
          $sql = mysqli_query($koneksi, "SELECT * FROM asset WHERE id = '$kd'");
          ...
          if (isset($_POST['update'])) {
            ...
            $update = mysqli_query($koneksi, "UPDATE asset SET asset_id='$asset_id', name='$name'  WHERE id='$kd'") or die(mysqli_error());
            if ($update) {
              echo '<script>sweetAlert({
	                                                   title: "Berhasil!", 
                                                        text: "Aset Berhasil di update!", 
                                                        type: "success"
                                                        },function(){
              ...
              echo '<script>sweetAlert({
	                                                   title: "Gagal!", 
                                                        text: "Aset Gagal di update, silahakan coba lagi!", 
                                                        type: "error"
                                                        });</script>';
            }
          }
                ...
                <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" class="col s12">
                  <div class="row">
                    <div class="input-field col s12">
                      ...
                      <input id="id_tiket" name="asset_id" value="<?php echo $row['asset_id']; ?>" type="text">
