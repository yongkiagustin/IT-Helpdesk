      ...
      <section id="content">
        ...
        <div class="container">
          ...
          if (isset($_GET['aksi']) == 'delete') {
            $id = $_GET['id'];
            $cek = mysqli_query($koneksi, "SELECT * FROM asset WHERE id='$id'");
            if (mysqli_num_rows($cek) == 0) {
              ...
              $delete = mysqli_query($koneksi, "DELETE FROM asset WHERE id='$id'");
              if ($delete) {
                echo '<script>sweetAlert({
	                                                   title: "Berhasil", 
          ...
          <div id="table-datatables">
            ...
            <a href="input-asset.php" class="btn-floating btn-small waves-effect waves-light teal darken-2" title="Input Aset"><i class="mdi-content-add "></i></a>
            <br /><br />
            <div class="row">
