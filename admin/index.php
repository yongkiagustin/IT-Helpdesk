                        ...
                        <div class="row">
                            <div class="col s12 m12 l6">
                                <ul id="projects-collection" class="collection">
                                    ...
                                    <?php
                                    $tanggal = date("Y/m/d");
                                    $query = "SELECT tiket.*, user.fullname as nama FROM tiket JOIN user ON (tiket.user_id = user.user_id) WHERE status='open' limit 7";
                            ...
                            <div class="col s12 m12 l6">
                                <ul id="issues-collection" class="collection">
                                    ...
                                    <?php
                                    $tanggal = date("Y/m/d");
                                    $query1 = "SELECT tiket.*, user.fullname as nama FROM tiket JOIN user ON (tiket.user_id = user.user_id) WHERE status='close' limit 7";
